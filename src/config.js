...
const ITEMS = {
  ...
  // Drill fuel items. Poppy and Dandelion are also legacy-ID quirks like
  // DRILL_MOTOR/FUEL_CANISTER above - confirmed via /resources/skyblock/items.
  POPPY: "RED_ROSE", // display name: "Poppy"
  DANDELION: "YELLOW_FLOWER", // display name: "Dandelion"
  ...
  HELIX_FOSSIL: "HELIX", // display name: "Helix Fossil"
